...
Çentikli MacBook'larda yüzen bildirimler açıkken çentik Glint'in adasına dönüşür. Bildirim gelince iki yana genişler: solda uygulamanın simgesi ve gelen bildirim sayısını gösteren rozet, sağda tüm bildirimleri temizleyen çarpı. Çentiğin üzerine gelince bekleyen bildirimler uygulamaya göre gruplanmış olarak açılır. Kartın konumu **Çentik** seçiliyse kart çentiğin hemen altından iner; **Yalnızca kart** stilinde ada görünmez.
